...
public:
    ...
    QLabel *label_21;
    QComboBox *comboBox_id_salle;
    QPushButton *pushButton_charger_id_salle;
    QWidget *tab_8;
...
""));
        ...
        label_4->setGeometry(QRect(220, 170, 55, 21));
        label_4->setFont(font1);
        label_5 = new QLabel(tab_3);
        label_5->setObjectName(QStringLiteral("label_5"));
        label_5->setGeometry(QRect(190, 210, 91, 20));
        label_5->setFont(font1);
        lineEdit_6 = new QLineEdit(tab_3);
        lineEdit_6->setObjectName(QStringLiteral("lineEdit_6"));
        lineEdit_6->setGeometry(QRect(300, 250, 241, 22));
        lineEdit_6->setStyleSheet(QLatin1String("border-image: whit\n"
""));
        label_6 = new QLabel(tab_3);
        label_6->setObjectName(QStringLiteral("label_6"));
        label_6->setGeometry(QRect(200, 250, 71, 16));
        label_6->setFont(font1);
        pushButton = new QPushButton(tab_3);
        pushButton->setObjectName(QStringLiteral("pushButton"));
        pushButton->setGeometry(QRect(310, 320, 151, 31));
        QFont font2;
...
"border-radius:10px;"));
        ...
        tableView->setGeometry(QRect(30, 50, 441, 351));
        tableView->setStyleSheet(QLatin1String("\n"
"border-image: whit\n"
""));
        pushButton_7 = new QPushButton(tab_5);
        pushButton_7->setObjectName(QStringLiteral("pushButton_7"));
        pushButton_7->setGeometry(QRect(570, 150, 111, 31));
        QFont font3;
        font3.setPointSize(10);
        font3.setBold(true);
        font3.setWeight(75);
        pushButton_7->setFont(font3);
        pushButton_7->setStyleSheet(QLatin1String("border-image: url(:/new/prefix3/orange.png);\n"
"border-radius:10px;"));
        pushButton_8 = new QPushButton(tab_5);
        pushButton_8->setObjectName(QStringLiteral("pushButton_8"));
        pushButton_8->setGeometry(QRect(570, 200, 111, 28));
        pushButton_8->setFont(font3);
        pushButton_8->setStyleSheet(QLatin1String("border-image: url(:/new/prefix3/orange.png);\n"
"border-radius:10px;"));
...
"border-radius:10px;"));
        ...
        tableView_3->setGeometry(QRect(20, 110, 791, 291));
...
""));
        ...
        lineEdit_15->setGeometry(QRect(190, 60, 151, 22));
        lineEdit_15->setStyleSheet(QLatin1String("border-image: whit\n"
""));
        pushButton_3 = new QPushButton(tab_6);
        pushButton_3->setObjectName(QStringLiteral("pushButton_3"));
        pushButton_3->setGeometry(QRect(350, 57, 151, 31));
        pushButton_3->setFont(font3);
        pushButton_3->setStyleSheet(QLatin1String("border-image: url(:/new/prefix3/orange.png);\n"
"border-radius:10px;"));
        ...
        label_16->setGeometry(QRect(210, 40, 81, 31));
        label_16->setFont(font1);
        label_17 = new QLabel(tab_7);
        label_17->setObjectName(QStringLiteral("label_17"));
        label_17->setGeometry(QRect(230, 90, 81, 21));
        label_17->setFont(font1);
        lineEdit_16 = new QLineEdit(tab_7);
        lineEdit_16->setObjectName(QStringLiteral("lineEdit_16"));
        lineEdit_16->setGeometry(QRect(300, 50, 231, 22));
        lineEdit_16->setStyleSheet(QLatin1String("border-image: whit\n"
""));
        pushButton_4 = new QPushButton(tab_7);
        pushButton_4->setObjectName(QStringLiteral("pushButton_4"));
        pushButton_4->setGeometry(QRect(330, 200, 151, 41));
        pushButton_4->setFont(font2);
        pushButton_4->setStyleSheet(QLatin1String("border-image: url(:/new/prefix3/orange.png);\n"
"border-radius:10px;"));
        comboBox_2 = new QComboBox(tab_7);
        comboBox_2->setObjectName(QStringLiteral("comboBox_2"));
        comboBox_2->setGeometry(QRect(300, 90, 231, 22));
        comboBox_2->setStyleSheet(QLatin1String("border-image: whit\n"
""));
        label_21 = new QLabel(tab_7);
        label_21->setObjectName(QStringLiteral("label_21"));
        label_21->setGeometry(QRect(160, 130, 131, 31));
        label_21->setFont(font1);
        comboBox_id_salle = new QComboBox(tab_7);
        comboBox_id_salle->setObjectName(QStringLiteral("comboBox_id_salle"));
        comboBox_id_salle->setGeometry(QRect(300, 140, 231, 22));
        comboBox_id_salle->setStyleSheet(QLatin1String("border-image: whit\n"
""));
        pushButton_charger_id_salle = new QPushButton(tab_7);
        pushButton_charger_id_salle->setObjectName(QStringLiteral("pushButton_charger_id_salle"));
        pushButton_charger_id_salle->setGeometry(QRect(530, 140, 75, 23));
        QFont font4;
        font4.setBold(true);
        font4.setWeight(75);
        pushButton_charger_id_salle->setFont(font4);
        pushButton_charger_id_salle->setStyleSheet(QStringLiteral("border-image: url(:/new/prefix3/orange.png);"));
        tabWidget_3->addTab(tab_7, QString());
        tab_8 = new QWidget();
        tab_8->setObjectName(QStringLiteral("tab_8"));
        tableView_4 = new QTableView(tab_8);
        tableView_4->setObjectName(QStringLiteral("tableView_4"));
        tableView_4->setGeometry(QRect(20, 30, 791, 371));
...
""));
        ...
        lineEdit_18->setGeometry(QRect(110, 30, 121, 31));
...
""));
        ...
        pushButton_5->setStyleSheet(QLatin1String("border-image: url(:/new/prefix3/orange.png);\n"
"border-radius:10px;"));
        comboBox = new QComboBox(tab_9);
        comboBox->setObjectName(QStringLiteral("comboBox"));
        comboBox->setGeometry(QRect(480, 40, 141, 31));
...
""));
    ...
    void retranslateUi(QDialog *chaise_producteur_page)
    {
        ...
        label_11->setText(QApplication::translate("chaise_producteur_page", "Email :", Q_NULLPTR));
        ...
        label_21->setText(QApplication::translate("chaise_producteur_page", "Numero de salle :", Q_NULLPTR));
        pushButton_charger_id_salle->setText(QApplication::translate("chaise_producteur_page", "Charger", Q_NULLPTR));
