...
void MainWindow::on_ajouter_administrateur_clicked()
{
...
void MainWindow::on_modifieradmin_clicked()
{
...
void MainWindow::on_supprimeradmin_clicked()
{
...
void MainWindow::on_afficheradmin_clicked()
{
    ADMINISTRATEUR ad;
    ui->tableViewadmin->setModel(ad.afficher());
}

void MainWindow::on_ajouterassis_clicked()
{
...
void MainWindow::on_modifierasis_clicked()
{
    QString nom=ui->nomassis->text();
    QString prenom=ui->prenomassis->text();
    QString mail=ui->emailassis->text();
...
void MainWindow::on_supprimerassis_clicked()
{
...
void MainWindow::on_afficherassis_clicked()
{
    ASSISTANT ass;
    ui->tableViewassis->setModel(ass.afficher());
}
...
void MainWindow::on_idrecherche_cursorPositionChanged(int arg1, int arg2)
{
    QString id=ui->idrecherche->text();
    ui->tableViewrechercher->setModel(ass.recherche(id));
}

void MainWindow::on_imprimeradmin_clicked()
{
    QPrinter printer;
