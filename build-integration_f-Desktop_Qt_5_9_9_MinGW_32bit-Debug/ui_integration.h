...
public:
    ...
    void setupUi(QMainWindow *Integration)
    {
        ...
        frame->setGeometry(QRect(240, 70, 431, 401));
        ...
        label_3->setGeometry(QRect(180, 70, 111, 31));
        QFont font;
        font.setPointSize(12);
        label_3->setFont(font);
        lineEdit_username = new QLineEdit(frame);
        lineEdit_username->setObjectName(QStringLiteral("lineEdit_username"));
        lineEdit_username->setGeometry(QRect(150, 130, 211, 31));
        QFont font1;
        ...
        label->setGeometry(QRect(40, 130, 108, 25));
        label->setFont(font1);
        lineEdit_password = new QLineEdit(frame);
        lineEdit_password->setObjectName(QStringLiteral("lineEdit_password"));
        lineEdit_password->setGeometry(QRect(150, 190, 201, 31));
...
""));
        ...
        graphicsView->setGeometry(QRect(390, 0, 151, 141));
    ...
    void retranslateUi(QMainWindow *Integration)
    {
        ...
        lineEdit_username->setPlaceholderText(QApplication::translate("Integration", "Username", Q_NULLPTR));
        label->setText(QApplication::translate("Integration", "Username :", Q_NULLPTR));
        lineEdit_password->setPlaceholderText(QApplication::translate("Integration", "Password", Q_NULLPTR));
        label_2->setText(QApplication::translate("Integration", "Password :", Q_NULLPTR));
